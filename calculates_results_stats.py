...
def calculates_results_stats(results_dic):
    ...
    n_correct_dogs = sum(
        result[3] == 1 and result[4] == 1 for result in results_dic.values()
    )
    n_correct_notdogs = sum(
        result[3] == 0 and result[4] == 0 for result in results_dic.values()
    )
    n_dogs_img = sum(result[3] for result in results_dic.values())
